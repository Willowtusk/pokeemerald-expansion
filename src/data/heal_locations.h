static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SELUNA_TOWN - 1] = {MAP_GROUP(SELUNA_TOWN_GENERAL), MAP_NUM(SELUNA_TOWN_GENERAL), 4, 22},
    [HEAL_LOCATION_DUSTROWE_CITY - 1] = {MAP_GROUP(DUSTROWE_CITY), MAP_NUM(DUSTROWE_CITY), 22, 10},
    [HEAL_LOCATION_FELUNDITY_TOWN - 1] = {MAP_GROUP(FELUNDITY_TOWN_MAIN), MAP_NUM(FELUNDITY_TOWN_MAIN), 8, 20},
};
