...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_SELUNA_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_ROUTE_701 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_RESEARCH_OUTPOST_LAMBDA - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_LAMBDA_CAVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_DUSTROWE_PATH - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_DUSTROWE_CITY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_ROUTE_702 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_FELUNDITY_FOREST - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_FELUNDITY_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_RESEARCH_OUTPOST_DELTA - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD
